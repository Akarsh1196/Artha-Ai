...
export default function Signup() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-surface-2 dark:bg-surface-2-dark py-12 px-4 sm:px-6 lg:px-8">
      <div className="w-full max-w-md p-8 space-y-8 bg-surface dark:bg-surface-dark rounded-2xl shadow-xl">
        <div className="text-center">
          ...
          <p className="mt-2 text-text-muted dark:text-text-muted-dark">Create your account</p>
        </div>
